...
from backbone_module_enc_complex_FP2_K8_G12_C3  import Pointnet2Backbone
...
class VoteNet(nn.Module):
    ...
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr,
        ...
        # Hough voting
        self.vgen = VotingModule(self.vote_factor, 256+256+256)

        # Vote aggregation and detection
        self.pnet = ProposalModule(num_class, num_heading_bin, num_size_cluster,
            mean_size_arr, num_proposal, sampling, seed_feat_dim=256+256+256)
